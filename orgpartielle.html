...
<head>
    ...
    <title>Organisation partielle</title>
    <link rel="stylesheet" href="../css/orgacomplete.css">
...
<body>
    <header>
        <div class="head_box">
            ...
            <div class="nav_bar">
                    <nav> 
                        <ul>
                            <a href="../html/inscrit.html"><li class="link_home">Accueil</li></a>
    ...
    <section class="section_coordination">
        <div class="coordination">
                ...
                <div class="slide_coordinate">
                    ...
                    <div class="slider_slick">
                        <div class="box_slider_coordinate">
                            <div class="picture9">
                                <img src="../images/Arches & Mariage.jpg">
                            </div>
                            <div class="picture9">
                                <img src="../images/heart.jpg">
                            </div>
                            <div class="picture9">
                                <img src="../images/9c1e5a18-e484-427a-aac7-f61bbbf156f2.jpg">
                            </div>
                        </div>
                    </div>
                    <div class="chevron">
            ...
            <div class="side2">
                <img src="../images/Arches & Mariage.jpg" alt="">
            </div>
        </div>
        <div class="big_step">
    ...
    <footer>
        <div class="footer">
            <div class="box1_footer">
                ...
                <p>Envoyer nous votre adresse email pour qu'on puisse vous publier les  <span class="offre">offres</span> & <span class="service">services</span> à ne pas rater!</p><br>
